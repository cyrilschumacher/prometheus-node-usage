...
describe("createMetricLabels", () => {
    it("should create metric", () => {
        const stub = proxyquire.noCallThru().load("../../../src/metric/builder/create", { "./label/create": { createMetricLabels: () => "" } });
    ...
    it("should create metric with labels", () => {
        const stub = proxyquire.noCallThru().load("../../../src/metric/builder/create", { "./label/create": { createMetricLabels: () => "{label=\"value\"}" } });
